...
if (Meteor.isClient) {
 //var Peanut = new (function(){
    ...
    function returnStates2(self){
      console.log(self)
      console.log('birthingArray'+self.nestedViewItem2.viewId+'-'+self.nestedViewItem2.viewIdX)
      var dataSets = {
        tvShowId: self.tvShowObj._id,
    ...
    function showHideView2(self){
      var s = returnStates2(self);
